...
router.route('/reports').
	get(bookValidations.dayValidator, validator, isAdmin, bookController.log);
...
router.route('/books/author/:name')
	.get(isEmployee, bookValidations.paramName, validator, bookController.getBooksByAuthor);

router.route('/books/publisher/:name')
	.get(isEmployee, bookValidations.paramName, validator, bookController.getBooksByPublisher);

router.route('/books/title/:name')
	.get(isEmployee, bookValidations.paramName, validator, bookController.getBooksByTitle);

router.route('/books/available')
	.get(isEmployee, bookController.getAvailableBooks);

router.route('/books/borrowing')
	.get(isEmployee, bookController.getBorrowingBooks);


router.route('/books/new')
	.get(isMember, bookController.getNewBooks);

router.route('/books/mostborrowed')
	.get(isEmployee, bookController.mostBorrowedBooks);

router.route('/books/mostborrowed/:year')
	.get(isEmployee, bookValidations.paramYear, validator, bookController.mostBorrowedBooks);

router.route('/books/mostreading')
	.get(isEmployee, bookController.mostReadingBooks);

router.route('/books/mostreading/:year')
...
router.route('/books/history/borrowed')
	.all(isMemberOnly)
	.get(bookController.memberBorrowedBooks);

router.route('/books/history/borrowed/:year')
	.all(isMemberOnly)
	.get(bookValidations.paramYear, validator, bookController.memberBorrowedBooks);

router.route('/books/history/borrowed/:year/:month')
	.all(isMemberOnly)
	.get(bookValidations.paramYear, validator, bookController.memberBorrowedBooks);
...
router.route('/books/history/reading')
	.all(isMemberOnly)
	.get(bookController.memberReadingBooks);

router.route('/books/history/reading/:year')
	.all(isMemberOnly)
	.get(bookValidations.paramYear, validator, bookController.memberReadingBooks);

router.route('/books/history/reading/:year/:month')
	.all(isMemberOnly)
	.get(bookValidations.paramYear, validator, bookController.memberReadingBooks);
