...
routes.post('/activation', saveImage('firstImage'), saveOnBody, imageUploader, validator.activation, validationMiddleware, activation);

routes.post(

	'/activation/administration',

	saveImage('firstImage'), imageUploader,
